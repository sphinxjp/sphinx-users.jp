...
拡張APIの `add_object_type <http://sphinx-users.jp/doc12/ext/appapi.html#sphinx.application.Sphinx.add_object_type>`_ 関数を使って、簡単に独自のディレクティブを定義することができます。専門用語が頻繁に出てくるような技術文書で力を発揮します。
